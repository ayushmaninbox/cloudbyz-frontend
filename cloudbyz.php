...
<head>
  ...
  <title>Cloudbyz eSign – Electronic Signature Platform</title>
  <!-- Bootstrap 4.5.1 -->
      ...
      <div class="col-lg-6 mb-5 mb-lg-0 pr-lg-4 py-lg-5">
        ...
        <div class="compliance-badges-row mt-2">
          <div class="compliance-badge">
            ...
            <span>ESIGN / UETA<br />Compliant</span>
          </div>
          <div class="compliance-badge">
            <div class="compliance-icon" style="background:#0b498c;">
              <img src="./public/Icon.svg" alt="eIDAS" />
            </div>
            <span>eIDAS<br />Recognized</span>
          </div>
          <div class="compliance-badge">
            <div class="compliance-icon" style="background:#09519b;">
              <img src="./public/Group-84107.svg" alt="GDPR" />
            </div>
            <span>GDPR<br />Aligned</span>
          </div>
          <div class="compliance-badge highlight">
            <div class="compliance-icon" style="background:#00a8ac;">
              <img src="./public/Group-84108.svg" alt="CFR" />
            </div>
            <span>21 CFR Part<br />11 Ready</span>
          </div>
        </div>
      </div>
  ...
  <div class="cb-container">
    ...
    <div class="capabilities-wrapper">
      ...
      <div class="d-flex flex-column" style="gap: 12px;">
        ...
        <p class="capability-desc">Set the order. Or don't. You decide.</p>
        <p class="capability-text">Cloudbyz eSign gives you explicit control over how multi-party agreements are executed. Configure a strict sequential order so no one signs out of turn, or use parallel mode to collect signatures simultaneously. Either way, every recipient receives a personalized, direct signing link — no account creation required.</p>
      </div>
          ...
          <div class="flow-diagram-row">
            <div class="flow-diagram-col">
              <div class="flow-circle">
                <img src="./public/Disconnected-e-signature6.svg" alt="Sequential" />
              </div>
              <div class="flow-title">Sequential</div>
              <div class="flow-desc">Each signer is notified only after the person before them completes their fields</div>
            </div>
            <div class="flow-diagram-col">
              <div class="flow-circle blue-circle">
                <img src="./public/Vector11.svg" alt="Parallel" />
              </div>
              <div class="flow-title">Parallel</div>
              <div class="flow-desc">All signers receive invitations simultaneously and can sign in any order</div>
            </div>
            <div class="flow-diagram-col">
              <div class="flow-circle blue-circle">
                <img src="./public/Vector12.svg" alt="Mixed" />
              </div>
              <div class="flow-title">Mixed</div>
              <div class="flow-desc">Configure per document — not locked to one mode globally</div>
            </div>
          </div>
        </div>
      </div>
  ...
  <div class="cb-container">
    <div class="org-wrapper">
      ...
      <div class="org-flow-box">
        <div class="org-flow-row">
          <!-- Card 1: Admin Controls (coral) -->
          <div class="org-flow-col" style="--oc:#DA6261; --ot:#FBEFEF;">
          ...
          <!-- Card 2: User Management (blue) -->
          <div class="org-flow-col" style="--oc:#47BDDD; --ot:#EDF8FC;">
            <div class="org-flow-icon">
          ...
          <!-- Card 3: Credit System (orange) -->
          <div class="org-flow-col" style="--oc:#FF854E; --ot:#FFF3ED;">
            <div class="org-flow-icon">
